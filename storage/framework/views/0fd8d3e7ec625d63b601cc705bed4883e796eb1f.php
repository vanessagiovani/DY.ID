        ...
        <div class="card" style="width: 21rem; margin-bottom:2%">
            ...
            <div class="card-body">
                <div style="justify-content:space-between; display:flex">
                    ...
                    <p class="card-title"><?php echo e($product->category->name); ?></p>
                </div>
                <p class="card-text">IDR. <?php echo e(number_format($product->price)); ?></p>
                <a href="/DY.ID/details<?php echo e($product->id); ?>" class="btn btn-primary text-black" style="background-color: #E8B200">More Details</a>
            </div>
        </div>
