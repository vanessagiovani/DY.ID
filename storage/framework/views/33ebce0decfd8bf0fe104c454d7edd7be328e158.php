...
<body>
    ...
    <div class="container-fluid text-white" style="background-color: #004C99; margin-top: -2.6%; padding-bottom:0.5%; padding-top:0.5%; display:flex; justify-content:space-between;">
        <div class="text-left d-flex">
            ...
            <a class="nav-link text-decoration-none text-reset" href="<?php echo e(route('users.cart')); ?>">My Cart</a>
            <a class="nav-link text-decoration-none text-reset" href="<?php echo e(route('users.historyTransaction')); ?>">History Transaction</a>
            <?php endif; ?>
            <?php endif; ?> 
        </div>
