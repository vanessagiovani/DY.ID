  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div align = "center" class="col-sm-8 p-3 border">
        <h3><?php echo e($a); ?> <?php echo e($b); ?> <?php echo e($c); ?></h3>
        <p>Name : <?php echo e($name); ?> <br> Age  : <?php echo e($age); ?> <br> DOB  : <?php echo e($dob); ?></p>
      </div>
      <div class="col-sm-2">
      </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\coba1\resources\views/LA02/display.blade.php ENDPATH**/ ?>