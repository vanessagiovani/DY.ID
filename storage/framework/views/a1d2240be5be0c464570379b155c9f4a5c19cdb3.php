...
<div class="row" style="justify-content:center">
    <div class="col-sm-10 p-3 border" style="background-color: white; margin-top: 2%; margin-bottom: 2%">
        ...
        <br>
        <form action="<?php echo e(route('admin.updateProduct', $product)); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name') ?? $product->name); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-select" name="category_id" id="category_id">
                    ...
                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('category') ?? $product->category_id == $category->id ? 'selected': ''); ?>><?php echo e($category->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                <br>
                <label>Image saved: <?php echo e(old('photo') ?? $product->photo); ?></label>
            </div>
            <br>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\resources\views/editproduct.blade.php ENDPATH**/ ?>